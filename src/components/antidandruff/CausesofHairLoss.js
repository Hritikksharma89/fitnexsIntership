...
const CausesofHairLoss = () => {
  const data = [
    {
      description:
        'Androgenetic alopecia (AGA) especially in men, hair loss because of genetic history of baldness'
    },
    {
      description:
        'Alopecia- autoimmune disorder affecting individual of any age or gender'
    },
    {
    ...
    {
      description:
        'Excessive use of tight caps, bandanas or wig and hair patches'
    },
    {
