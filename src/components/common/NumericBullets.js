          ...
          <p
            className={cx(
              'text-[#3e3e3e] text-[1.125rem] leading-[1.825rem] font-normal',
              {
                ...
                'text-[#060606] text-[1.5rem] md:leading-[3.125rem] font-semibold':
                  boldLargeDescription,
                ...
                <span className='flex gap-x-4'>
                      ...
                      className={cx(
                        'bg-[#000] text-[#FFF] text-[1.6rem] leading-[1.825rem] font-semibold h-9 w-9 md:h-14 md:w-14 rounded-full flex shrink-0 items-center justify-center',
                        {
                          'bg-[#fff] !text-[#000] h-9 w-9 md:h-14 md:w-14 rounded-full flex shrink-0 items-center justify-center':
                            colorReversal,
                          '!bg-[#fff] !text-[#000] border-2 border-[#000] h-9 w-9 md:h-14 md:w-14 rounded-full flex shrink-0 items-center justify-center':
                            colorForWhiteBG
                        }
                      )}>
                      {id}
                  ...
                  <span
                    className={cx(
                      ...
                      {
                        '!text-[#fff] leading-[1.8125rem] flex flex-col justify-center text-center sm:text-start':
                          colorReversal,
                        '!text-[#060606] leading-[1.8125rem] flex flex-col justify-center text-center sm:text-start':
                          colorForWhiteBG
                      }
                    )}>
                    <div
                      className={cx('', {
                        hidden: topicNotNeeded
                      })}>
