  ...
  return (
    <>
      <div className='w-[92%] sm:w-[96%] lg:w-[96%] mx-auto text-center my-2 py-2 pb-3 overflow-x-clip'>
        ...
        <div
          className={cx(
            'hidden lg:flex lg:flex-row w-[88%] gap-x-2 gap-y-4 mx-auto py-4 justify-center justify-items-center',
            {
              'justify-evenly justify-items-center lg:flex-wrap gap-x-2 lg:!gap-x-[6rem] 2xl:!gap-x-36 px-0':
                largerGap,
