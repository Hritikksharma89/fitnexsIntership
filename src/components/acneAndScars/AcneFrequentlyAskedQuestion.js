              ...
              {data2?.map(({ question, answer }, index) => {
                ...
                return (
                  <div
                    ...
                    className='border-b border-[#D3D3D3] py-8'>
                    <div
                      onClick={() => handleAccordian2(index)}
                      className='flex justify-between  '>
                      <p>{question} </p>
                      <div>
                        {isopen2 ? (
