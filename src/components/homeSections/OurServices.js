      ...
      <div className='bg-secondary p-8'>
        ...
        <div className='md:flex items-center'>
          ...
          <div className='md:w-1/2 text-[16px] text-[#666666] font-normal'>
            We are dedicated to unlocking your true radiance. Explore our range
            of personalized treatments and let your inner beauty shine through.
            Your journey to self-confidence begins here
          </div>
        </div>
