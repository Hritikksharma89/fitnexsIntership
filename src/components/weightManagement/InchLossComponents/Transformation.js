        ...
        <div className='bg-gradient-to-r from-[#632A3D] to-[#350340] text-[#fff] mt-6 md:mt-14 py-2 md:py-7'>
          <div className=' w-[85%] lg:w-[87%] mx-auto py-2 md:py-6'>
            <p className='text-[15px] sm:text-[18px] md:text-[24px] py-2 sm:py-5 text-center text-normal  md:leading-[25px] lg:leading-[36px]  '>
              Experience the future of inch loss and body transformation with
              KOZA AESTHETIC CARE Non-Surgical Liposuction. Achieve remarkable
              results in just one session, and embrace a new you with
              confidence. Contact us today to schedule your session and unlock
              the power of permanent inch loss and skin rejuvenation.
            </p>
          </div>
        </div>
      </div>
