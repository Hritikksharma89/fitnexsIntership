      ...
      <div className='bg-gradient-to-r from-[#632A3D] to-[#350340] text-[#fff] mt-6 md:mt-16 py-6 md:py-12'>
        <div className='w-[80%] lg:w-[90%] mx-auto md:py-6'>
          <p className='text-[15px] sm:text-[18px] md:text-[24px] py-2 sm:py-5 text-center md:leading-[25px] lg:leading-[36px]'>
            At KOZA Aesthetic Care, we offer a range of advanced inch loss and
            body sculpting treatments designed to help you achieve your desired
            body contours and shed those extra inches. Our innovative therapies
            are tailored to target stubborn fat, cellulite and provide overall
            body rejuvenation.
          </p>
        </div>
      </div>
