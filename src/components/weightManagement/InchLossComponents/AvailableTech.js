  ...
  const contentTwo = [
    {
      ...
      description:
        'This helps break down fat cells and promote inch loss in the targeted area.'
    },
    {
      id: 2,
      topic: 'Firming gel',
      description:
        'This gel works in synergy with the massage to tighten and tone the skin, enhancing the overall effects.'
    },
    {
      id: 3,
      topic: 'Lipolaser technology',
      description:
        'This enhances the tightening and toning effects. This technology promotes fat cell breakdown and improves skin elasticity.'
    },
    {
      id: 4,
      topic: 'Lymphatic system detox',
      description:
        'Our therapies also aid in improving circulation and eliminating toxins from the lymphatic system, helping your body naturally remove waste products.'
    },
    {
      id: 5,
      topic: 'Firming packs',
      description:
        'To complete the treatment, we use a firming pack that enhances skin elasticity and improves muscle tone. This contributes to overall body firming and shaping'
    }
  ]
  return (
    <>
