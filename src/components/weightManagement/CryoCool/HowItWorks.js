        ...
        <div className='bg-gradient-to-r from-[#632A3D] to-[#350340] text-[#fff] mt-6 md:mt-14'>
          <div className=' w-[85%] lg:w-[76%] mx-auto md:py-8'>
            <p className='text-[15px] sm:text-[18px] md:text-[24px] py-2 sm:py-5 text-center md:leading-[25px] lg:leading-[36px]'>
              {' '}
              At koza , we understand that achieving your desired body shape is
              important. To help you make an informed decision, we offer a
              complimentary consultation with our experienced team.{' '}
            </p>
            <p className='text-[15px] sm:text-[18px] md:text-[24px] py-2 sm:py-5 text-center md:leading-[25px] lg:leading-[36px]'>
              During this consultation, we will discuss your goals, answer your
              questions, and determine if cryo cool sculpting is the right
              option for you.{' '}
            </p>
          </div>
        </div>
