          ...
          titleDescription={
            <div className='grid gap-y-6'>
              <p className='text-[18px] font-normal'>
                ...
                energy. A single EMSCULPT session feels like thousands of
                powerful muscle contractions which are extremely important in
                improving the tone and strength of your muscles.
              </p>
              <p>
                These powerful induced muscle contractions not achievable
                through voluntary contractions. The muscle tissue is forced to
                adapt to such extreme condition. It responds with a deep
                remodelling of its inner structure that results in muscle
