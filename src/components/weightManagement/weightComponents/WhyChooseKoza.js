    ...
    <>
      ...
      <div className='mx-0 my-16 px-2 md:px-[7rem] py-8 text-[#fff] text-center bg-gradient-to-r from-[#632A3E] to-[#370541]'>
        <p className='font-normal text-[18px] sm:text-[20px] md:text-[24px]'>
          Ready to start your journey towards a healthier, happier you? Contact
          KOZA Aesthetic Care today and discover the difference our holistic
          approach can make in your weight loss journey. Your transformation
          begins here.
        </p>
      </div>
    </>
