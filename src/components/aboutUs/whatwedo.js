      ...
      <div className='bg-gradient-to-r from-[#632A3D] to-[#350340] text-[#fff] my-12'>
        <div className='w-[90%] sm:w-[75%] mx-auto py-12 grid gap-y-4'>
          ...
          <p className='text-[15px] sm:text-[18px] py-2 sm:py-5 text-center '>
            If you seek a destination where the finest treatments for all your
            cosmetic needs converge, Koza is unquestionably your one-stop
            destination. Our commitment to your beauty and wellness knows no
            bounds, and we are here to ensure that every visit to Koza is a
            transformative experience.
          </p>
          <p className='text-[15px] sm:text-[18px] py-2 sm:py-5 text-center'>
            Embrace the koza philosophy, where beauty is an authentic expression
            of your unique self, and wellness is a holistic journey towards
            confidence, empowerment, and self-discovery. Join us on this
            remarkable voyage, where your beauty and wellness aspirations become
            a reality.
          </p>
