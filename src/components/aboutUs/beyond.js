      ...
      <div className=''>
        <div className='mx-auto w-[95%] lg:w-[75%] mb-12'>
          ...
          <p className='text-center text-[1.125rem] leading-[1.8125rem] font-normal'>
            At Koza, we are dedicated to redefining beauty and instilling
            confidence in every individual who walks through our doors. Our
            mission is simple: to provide the best treatments in an environment
            where customer comfort and safety are our top priorities.
          </p>
        </div>
        <div className='mb-12'>
        ...
        <div className='bg-gradient-to-r from-[#632A3D] to-[#350340]'>
          <div className='text-[#fff] w-full sm:w-[75%] md:w-[55%] leading-5 md:leading-[40px] px-2 sm:mx-auto text-center py-4 sm:py-10'>
            <p className='text-[15px] sm:text-[18px]'>
              Join us at Koza Aesthetic Care and experience a transformation
              that goes beyond aesthetics - one that encompasses confidence,
              self-assurance, and empowerment. Your journey to beauty and
              freedom begins here.
            </p>
