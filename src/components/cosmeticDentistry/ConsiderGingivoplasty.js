    ...
    <div className='my-20'>
      ...
      <div className='bg-gradient-to-r from-[#632A3E] to-[#370541] text-center text-[#fff] mt-10 py-8 px-16'>
        <p className='text-[18px] md:text-[1.5rem] md:leading-[36px] font-normal'>
          In summary, gingivoplasty is a versatile procedure that offers both
          aesthetic and oral health benefits. Whether you have genetic,
          traumatic, or aesthetic concerns related to your gum tissue,
          gingivoplasty can help you achieve a more balanced and beautiful
          smile. To explore whether this procedure is suitable for your unique
          needs, consult with Koza’s qualified dental professional who can
          assess your condition and discuss a personalized treatment plan
