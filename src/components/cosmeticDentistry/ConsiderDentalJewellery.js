    ...
    <div className='mt-[2rem] md:mt-[7rem]'>
      ...
      <div className='bg-gradient-to-r from-[#632A3E] to-[#370541] text-center text-[#fff] mt-10 py-8 px-16'>
        <p className='text-[18px] md:text-[1.5rem] md:leading-[36px] font-normal'>
          ...
          fashionable way to enhance your smile without any invasive procedures
          or damage to your enamel. With a variety of designs to choose from,
          it's a customizable and temporary enhancement that allows you to
          express your unique style and individuality through your smile.
          Whether you're looking for a special accent for an event or simply
          want to add a touch of sparkle to your everyday life, dental jewellery
          can be a delightful and non-permanent addition to your smile. Consult
          with Koza’s dental professional to explore your options and discover
          how dental jewellery can elevate your smile.
        </p>
      </div>
    </div>
  )
