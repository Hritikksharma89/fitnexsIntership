    ...
    <>
      <div className=' mx-auto w-[90%] md:w-[80%] flex gap-y-5 flex-col my-2 py-2 '>
        ...
        <div className='text-center text-[18px] md:text-[24px] leading-[36px] py-2 text-[#3E3E3E] '>
          To improve the appearance of moderate to severe frown lines and crow’s
          feet lines, it is the only approved treatment. Being one of the most
          extensively researched medical aesthetic treatments, it is now a
          trusted and reliable treatment. Due to its significant results in
          improving the facial aesthetics, it is widely used by people all
          around the world.
        </div>
