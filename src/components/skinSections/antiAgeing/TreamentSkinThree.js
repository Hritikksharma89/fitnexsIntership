      ...
      <div className='bg-gradient-to-r from-[#632A3D] to-[#350340] text-[#fff] mt-6 md:mt-14 py-2'>
        <div className='w-[85%] lg:w-[83%] mx-auto px-4 py-2 md:py-6'>
          <p className='text-[18px] md:text-[24px] py-2 sm:py-5 text-center text-normal lg:leading-[36px]'>
            The proven results of Ultherapy are clear, appearing over two to
            three months as new collagen works to lift skin on the neck, chin,
            and brow—as well as smooth skin on the upper chest. Results may
            improve over the following three to six months, and can last a year
            or more. It won’t duplicate the results of a surgical facelift, but
            Ultherapy is a clinically proven non-invasive alternative for those
