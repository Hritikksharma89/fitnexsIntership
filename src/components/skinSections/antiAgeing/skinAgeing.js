  ...
  return (
    <>
      <div>
        ...
        <ImageScale
          heading='What’s at koza aesthetic care?'
          matter='We provide 2 kinds of treatments'
          contentMatter={contentMatterTwo}
        />
          ...
          <div className='flex gap-x-2 p-2 h-[100%] justify-center items-center'>
            <div className='px-6  '>
              ...
              <p className='text-[15px] lg:text-[18px] my-[1px] lg:my-2 w-[95%]'>
                The ideal candidate for the treatment has to be in excellent
                physical health and above 18 years of age. The degree of
                effectiveness of the treatment may vary from one patient to
                another.
              </p>
            </div>
          </div>
