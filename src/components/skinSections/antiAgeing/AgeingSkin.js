    ...
    <>
      ...
      <div className='w-[85%] mx-auto text-center py-2 px-4'>
        <p className='text-[18px] md:text-[24px] lg:leading-[36px]'>
          While some of the skin-related factors can be reined in with healthy
          lifestyle choices and a good skincare regime, many of the
          characteristics of ageing are a matter of genetics.
        </p>
      </div>
      ...
      <div className='bg-gradient-to-r from-[#632A3D] to-[#350340] text-[#fff] my-6 md:mt-14 py-2'>
        <div className='w-[85%] mx-auto py-2 md:py-6'>
          ...
          <p className='text-[15px] sm:text-[18px] py-2 sm:py-5 text-center text-normal lg:leading-[36px]'>
            There are a range of different factors that cause our skin to age
            both as a result of the natural ageing process, environmental and
            lifestyle factors. Ultra violet rays are a major contributor to skin
            ageing in australia, although smoking, stress, medication, climate,
            alcohol and several others way in.
          </p>
        </div>
      </div>
    </>
