...
const AskedQuestion = ({
  ...
  return (
    <>
      <div className=''>
        <div
          className={cx('bg-tertiary pt-4', {
            'bg-white': colorReversal
          })}>
          <p
            className={cx(
              'text-[#FFF] text-[22px] md:text-[28px] lg:text-[40px] text-center font-semibold mx-auto',
              { '!text-[#000]': colorReversal }
            )}>
              ...
              return (
                <div
                  ...
                  <div
                    ...
                    <span
                      className={cx(
                        'text-[#FFF] font-normal text-[1.125rem] px-1',
                        {
                          '!text-[#000]': colorReversal
                        }
                      )}>
