      ...
      <div className='relative w-full bg-cover bg-no-repeat bg-treatmentBG min-h-[100vh]  '>
        <div>
          ...
          <p className='text-center text-[#3e3e3e] font-medium text-[16px] sm:text-[18px] md:text-[20px] leading-[30px] md:leading-[40px] w-[98%] sm:w-[73%] mx-auto mt-8 py-6'>
            Whether you have specific skin concerns or simply want to revitalize
            your complexion, a chemical peel may be the solution you've been
            searching for. Contact KOZA Skin Experts today to schedule a
            consultation and discover how chemical peels can enhance your skin's
            natural beauty.
          </p>
