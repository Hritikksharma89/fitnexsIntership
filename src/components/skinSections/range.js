      ...
      <div className='bg-gradient-to-r from-[#632A3E] to-[#370541]'>
        <div className=' w-[97%] md:w-[80%] mx-auto text-white text-center py-10 '>
          ...
          <p className='py-3 font-normal text-[16px] sm:text-[18px] leading-[29px]'>
            A chemical peel is a cosmetic dermatological procedure that uses
            specially formulated chemical solutions to improve the texture and
            appearance of your skin. During a chemical peel, the top layer of
            your skin is exfoliated, encouraging the growth of new, healthier
            skin cells. This treatment is highly effective in addressing a
            variety of skin concerns, such as fine lines, acne scars, age spots,
