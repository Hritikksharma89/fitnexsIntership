  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        cosmeticDentistBG: 'url(assets/cosmeticDentist/cosmeticDentist.png)',
        cosmeticSurgeryBG: 'url(assets/cosmeticSurgery/cosmeticSurgery.png)',
        figureChange: 'url(assets/weightMangement/figureCorrectionImg.png)',
        cyroCool: 'url(assets/weightMangement/cyrobgImg.png)',
        WeightLossGainBG: 'url(assets/weightMangement/weightLossGainBG.png)',
        ...
        Antiageingbg: 'url(assets/skinImg/antiageingimg/antiagingpic.png)',
        whatAreDarkCircle: 'url(assets/darkCircle/WhatAreDarkCircleBg .png)',

        MicroneedlingPrpBg: 'url(assets/Acne-scar/images/MicroneedingPrpBg.png)'
      }
    },
    colors: {
      primary: '#EDC08B',
